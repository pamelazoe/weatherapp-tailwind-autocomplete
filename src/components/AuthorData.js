const AuthorData = ({
  ...
  return (
    <div className="grid grid-cols-12 items-center w-full md:w-full">
      <a
        href={portfolio_url}
        target="_blank"
        rel="noopener noreferrer"
        className="col-start-1 col-span-6 text-white font-medium tracking-widest text-sm md:text-2xl"
      >
        {name}
      </a>
      <div className="col-start-7 col-end-13 flex flex-row justify-end md:w-full">
